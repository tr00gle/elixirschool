...
At the moment, Elixir community has come to some conventions regarding returning errors:
...
Usually, in public APIs, you can also find a second version of the function with a ! (example!/1) that returns the unwrapped result or raises an error.
